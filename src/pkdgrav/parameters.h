...
#endif
#ifdef SPINUP
  int bUseAngMomSpinup;
  int bSpinupAlignAxes;
  double dSpinupPeriodStart;
  double dSpinupPeriodInter;
  double dSpinupPeriodFinal;
  int nSpinupStepsStart;
  int nSpinupStepsInter;
  int nSpinupStepsFinal;
  int nSpinupStepsHold;
  int nSpinupStepsRestNum;
  int nSpinupStepsRestTime;
  double dSpinupRadiusInner;
  double dSpinupRadiusOuter;
  double dSpinupCoheCoeff;
  int nSpinupCoheTime;
#endif
