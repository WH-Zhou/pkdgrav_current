...
#define INTERSECT_DEM_FIXED_BALL(nx,ny,nz,lx,ly,lz,x,y,z,sx,sy,sz,bPeriodic)\
{\
	FLOAT INTRSCT_dx,INTRSCT_dy,INTRSCT_dz;\
	FLOAT INTRSCT_dx1,INTRSCT_dy1,INTRSCT_dz1;\
	INTRSCT_dx = nx-x;\
	INTRSCT_dx1 = -INTRSCT_dx;\
	INTRSCT_dy = ny-y;\
	INTRSCT_dy1 = -INTRSCT_dy;\
	INTRSCT_dz = nz-z;\
	INTRSCT_dz1 = -INTRSCT_dz;\
	if (INTRSCT_dx > 0.0) {\
		INTRSCT_dx1 += lx;\
		if (INTRSCT_dx1 < INTRSCT_dx) {\
			sx = x+lx;\
...
#ifdef SLIDING_PATCH
#define INTERSECT_DEM_FIXED_BALL_SLIDING_PATCH(nx,ny,nz,lx,ly,lz,x,y,z,sx,sy,sz,bPeriodic)\
{\
  FLOAT INTRSCT_dx,INTRSCT_dy,INTRSCT_dz;\
  FLOAT INTRSCT_dx1,INTRSCT_dy1,INTRSCT_dz1;\
  sy = y;\
