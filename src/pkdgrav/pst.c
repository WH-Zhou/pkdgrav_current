...
pstAddServices(PST pst,MDL mdl)
{
...
#ifdef FAST_AGGS
	mdlAddService(mdl,PST_AGGSCACHEINIT,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsCacheInit,
				  0,0);		//JVD
#endif /* FAST_AGGS */
	...
	mdlAddService(mdl,PST_LOCALORDER,pst,
				  ...
				  0,0);
#ifdef FAST_AGGS
	mdlAddService(mdl,PST_LOCALAGGORDER,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstLocalAggOrder,
				  0,0);	//JVD
#endif /* FAST_AGGS */
...
#ifdef GR_DRAG
	mdlAddService(mdl,PST_GRDRAGGETSUNACCEL,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstGRDragGetSunAccel,
				  sizeof(struct inGRDragGetSunAccel),sizeof(struct outGRDragGetSunAccel));
	mdlAddService(mdl,PST_GRINTEGRATECLOSEPARTICLES,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstGRIntegrateCloseParticles,
		      sizeof(struct inGRIntegrateCloseParticles),sizeof(struct outGRIntegrateCloseParticles));
	mdlAddService(mdl,PST_GRCORRECTASUN,pst,
                                  (void (*)(void *,void *,int,void *,int *)) pstGRCorrectaSun, 
				  sizeof(struct inGRCorrectaSun),0);
#endif /*GR_DRAG*/
	...
	mdlAddService(mdl,PST_GETMASSCHANGE,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstGetMassChange,
				  0,sizeof(struct outGetMassChange));
	...
	mdlAddService(mdl,PST_RANDSEEDGENERATOR,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstRandSeedGenerator,
				  0,0);
	...
	mdlAddService(mdl,PST_ADDUNIFGRAV,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAddUnifGrav,
				  sizeof(struct inAddUnifGrav),0);
...
#ifdef JOHNNY
	mdlAddService(mdl,PST_FINDESCAPERS,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstFindEscapers,
				  sizeof(struct inFindEscapers),sizeof(struct outFindEscapers));
	mdlAddService(mdl,PST_CHECKFORKEPLER,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstCheckForKepler,
				  sizeof(struct inCheckForKepler),sizeof(struct outCheckForKepler));
#endif /* JOHNNY */
#endif /* COLLISIONS */
	...
	mdlAddService(mdl,PST_FINDTIGHTESTBINARY,pst,
	...
	mdlAddService(mdl,PST_AGGSCOUNTPART,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsCountPart,
				  sizeof(struct inAggsCountPart),sizeof(struct outAggsCountPart));
...
#ifdef FAST_AGGS
	mdlAddService(mdl,PST_AGGSGETREF,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsGetRef,
				  sizeof(struct inAggsGetRef),sizeof(struct outAggsGetRef));
	mdlAddService(mdl,PST_AGGSGETPERIODICCOM,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsGetPeriodicCOM,
				  sizeof(struct inAggsGetPeriodicCOM),sizeof(struct outAggsGetPeriodicCOM));
	mdlAddService(mdl,PST_AGGSSETUNWRAPPED,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsSetUnwrapped,
				  sizeof(struct inAggsSetUnwrapped),0);
#endif /*FAST_AGGS*/
...
#else /* DEM */
	mdlAddService(mdl,PST_AGGSGETACCELANDTORQUEDEM,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsGetAccelAndTorqueDEM,
				  sizeof(struct inAggsGetAccelAndTorqueDEM),sizeof(struct outAggsGetAccelAndTorqueDEM));
	mdlAddService(mdl,PST_AGGSSETMASSDEM,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsSetMassDEM,
				  sizeof(struct inAggsSetMassDEM),0);
#endif /* DEM */
#endif /* AGGS */
#ifdef WALLS
	mdlAddService(mdl,PST_WALLSUPDATESTUCKPARTICLES,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstWallsUpdateStuckParticles,
				  sizeof(struct inWallsUpdateStuckParticles),0);
#endif /* WALLS */
#ifdef SPRINGS
	mdlAddService(mdl,PST_BREAKSPRINGS,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstBreakSprings,
				  sizeof(struct inBreakSprings),0);
#endif /* SPRINGS */
#ifdef DEM
	mdlAddService(mdl,PST_DEMZEROSMALLMOTIONS,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMZeroSmallMotions,
				  sizeof(struct inDEMZeroSmallMotions),0);
	mdlAddService(mdl,PST_DEMSTATS,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMStats,
				  0,sizeof(struct outDEMStats));
#ifdef DEM_FIXED_BALL
	mdlAddService(mdl,PST_DEMSETBALL,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMSetBall,
				  sizeof(struct inDEMSetBall),0);
	mdlAddService(mdl,PST_DEMGETBALLRADIUS,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMGetBallRadius,
				  sizeof(struct inDEMGetBallRadius),sizeof(struct outDEMGetBallRadius));
	mdlAddService(mdl,PST_DEMFIXEDBALLNEXTLARGEST,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMFixedBallNextLargest,
				  0,0);
#endif /* DEM_FIXED_BALL */
#ifdef DEM_WALLS_REACT
	mdlAddService(mdl,PST_DEMWALLSREACT,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMWallsReact,
				  0,sizeof(struct outDEMWallsReact));
#endif /* DEM_WALLS_REACT */
#endif /* DEM */
#ifdef CHARGE
	mdlAddService(mdl,PST_CHARGEZGETMOMENTS,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstChargeZGetMoments,
				  sizeof(struct ioChargeZMoments),0);
	mdlAddService(mdl,PST_CHARGEZAPPLYMOMENTS,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstChargeZApplyMoments,
				  0,sizeof(struct ioChargeZMoments));
#endif /* CHARGE */
#ifdef DEM_TIDAL_SPACE
	mdlAddService(mdl,PST_DEMTIDALFINDPLANET,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMTidalFindPlanet,
				  sizeof(struct inDEMTidalFindPlanet),sizeof(struct outDEMTidalFindPlanet));
	mdlAddService(mdl,PST_DEMTIDALFINDMARKER,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMTidalFindMarker,
				  sizeof(struct inDEMTidalFindMarker),sizeof(struct outDEMTidalFindMarker));
#endif /* DEM_TIDAL_SPACE */
#ifdef DEM_TIDAL_LOCAL
	mdlAddService(mdl,PST_DEMTIDAL,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstDEMTidal,
				  sizeof(struct inDEMTidal),0);
...
#endif /* SLIDING_PATCH */
#ifdef AGGS_IN_PATCH
	mdlAddService(mdl,PST_AGGSINPATCHGETREF,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsInPatchGetRef,
				  sizeof(struct inAggsInPatchGetRef),sizeof(struct outAggsInPatchGetRef));
	mdlAddService(mdl,PST_AGGSINPATCHGETUNWRAPPED,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsInPatchGetUnwrapped,
				  sizeof(struct inAggsInPatchGetUnwrapped),0);
	mdlAddService(mdl,PST_AGGSINPATCHOFFSET,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstAggsInPatchOffset,
				  sizeof(struct inAggsInPatchOffset),0);
#endif /* AGGS_IN_PATCH */
#ifdef SPINUP
	mdlAddService(mdl,PST_SPINUPGETAGG,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstSpinupGetAgg,
				  sizeof(struct inSpinupGetAgg),sizeof(struct outSpinupGetAgg));
	mdlAddService(mdl,PST_SPINUPALIGN,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstSpinupAlign,
				  sizeof(struct inSpinupAlign),0);	
	mdlAddService(mdl,PST_SPINUP,pst,
				  (void (*)(void *,void *,int,void *,int *)) pstSpinup,
				  sizeof(struct inSpinup),0);	
#endif /* SPINUP */
#ifdef SPINUP_WITH_AGGS
    mdlAddService(mdl,PST_SPINUPACCEL,pst,
                  (void (*)(void *,void *,int,void *,int *)) pstSpinupAccel,
                  sizeof(struct inSpinupAccel),0);
    mdlAddService(mdl,PST_SPINUPRESETAGGS,pst,
                  (void (*)(void *,void *,int,void *,int *)) pstSpinupResetAggs,
                  0,0);
#endif /* SPINUP_WITH_AGGS */
#if defined(RUBBLE_ZML) || defined(COLLMOD_ZML)
	mdlAddService(mdl,PST_DUSTBINSINCLAVG,pst,
				  (void (*)(void*,void*,int,void*,int*)) pstDustBinsInclAvg,
				  0,sizeof(struct outDustBinsInclAvg));
	mdlAddService(mdl,PST_DUSTBINSINCLMAX,pst,
				  (void (*)(void*,void*,int,void*,int*)) pstDustBinsInclMax,
				  0,sizeof(struct outDustBinsInclMax));
	...
	mdlAddService(mdl,PST_COLLMODRESETCOLFLAG,pst,
				  (void (*)(void*,void*,int,void*,int*)) pstCollModResetColFlag,0,0);
	mdlAddService(mdl,PST_COLLMODCHECKFORKDKRESTART,pst,
				  (void (*)(void*,void*,int,void*,int*)) pstCollModCheckForKDKRestart,
				  0,sizeof(struct outCollModCheckForKDKRestart));
	mdlAddService(mdl,PST_COLLMODSTEP,pst,
				  (void (*)(void*,void*,int,void*,int*)) pstCollModStep,
				  sizeof(struct inCollModStep),0);
#endif /* RUBBLE_ZML, COLLMOD_ZML */
#ifdef ORIGIN_HISTOGRAM
	mdlAddService(mdl,PST_INITIALIZEORIGINBINS,pst,
				  (void (*)(void*,void*,int,void*,int*)) pstInitializeOriginBins,
				  sizeof(struct inInitializeOriginBins),0);
...
void pstRandSeedGenerator(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	mdlassert(pst->mdl,nIn == 0);
	if (pst->nLeaves > 1) {
		pstRandSeedGenerator(pst->pstLower,NULL,0,NULL,NULL);
		mdlReqService(pst->mdl,pst->idUpper,PST_RANDSEEDGENERATOR,NULL,0);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else {
		/* generates pseudo-random seed for random number generator */
		/* Ullong ullSeed = time(NULL) % getpid() + getppid()*pst->idSelf; */
...
#else
	int NUM_SAFETY = 32; 	/* minimum margin space per processor when filling up memory */
#endif
	...
	*/
	...
	ittr = -1;
        ...
        if (bDoRootFind || fm<fl || fm>fu ) {
	     ...
	     inWt.ittr = 0;
	     inWt.iSplitSide = 1;
	     inWt.pFlag = 1; /*DEBUG RUBBLE_ZML - Zoe found that parallel runs decomposed better with this set to 0 */
	     ...
	     /*DEBUG not used nTotalActive = outWtLow.nLow + outWtHigh.nLow
	       + outWtLow.nHigh + outWtHigh.nHigh;*/
	     pFlag = 1; /*DEBUG RUBBLE_ZML - Zoe found that parallel runs decomposed better with this set to 0 */
	     if (!bDoRootFind) {
	...
	mdlassert(pst->mdl,nOut/sizeof(OREJ) == (size_t) pst->nLower);
	mdlGetReply(pst->mdl,pst->idUpper,pUpperRej,&nOut);
	mdlassert(pst->mdl,nOut/sizeof(OREJ) == (size_t) pst->nUpper);
...
#else
	if (fabs(dMass - outMass.dMass) > CONSERVE_FRAC*dMass) 
#endif
	        {
...
#ifdef FAST_AGGS
/*
** Initialize integers used for FAST_AGGS cache line on each processor
*/
void pstAggsCacheInit(PST pst,void *vin,int nIn,void *vout,int *pnOut)	//JVD
{
	LCL *plcl = pst->plcl;
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSCACHEINIT,NULL,0);
		pstAggsCacheInit(pst->pstLower,NULL,0,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else {
		plcl->pkd->iNextFastAgg = -1;
		plcl->pkd->iLastFastAggStart = -1;
		plcl->pkd->iLastFastAggIdx = -1;
		}
	if (pnOut) *pnOut = 0;
	}
#endif /* FAST_AGGS */
...
#ifdef FAST_AGGS
void pstLocalAggOrder(PST pst,void *vin,int nIn,void *vout,int *pnOut)	// JVD
{
	LCL *plcl = pst->plcl;

	mdlassert(pst->mdl,nIn == 0);
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_LOCALAGGORDER,NULL,0);
		pstLocalAggOrder(pst->pstLower,NULL,0,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else {
		pkdLocalAggOrder(plcl->pkd);
		}
	if (pnOut) *pnOut = 0;
	}
#endif /* FAST_AGGS */
...
#ifdef GR_DRAG
void pstGRDragGetSunAccel(PST pst,void *vIn,int nIn,void *vOut,int *pnOut) {
	struct inGRDragGetSunAccel *in = vIn;
	struct outGRDragGetSunAccel *out = vOut;
	double aSun[3];
	int k;

	mdlassert(pst->mdl,nIn == sizeof(struct inGRDragGetSunAccel));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_GRDRAGGETSUNACCEL,vIn,nIn);
		pstGRDragGetSunAccel(pst->pstLower,vIn,nIn,vOut,NULL);
		for (k=0;k<3;k++)
			aSun[k] = out->aSun[k];
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		for (k=0;k<3;k++)
		...
		pkdGRDragGetSunAccel(pst->plcl->pkd,in->dSunMass,out->aSun);
		}

	if (pnOut != NULL)
		*pnOut = sizeof(struct outGRDragGetSunAccel);
	}

void pstGRIntegrateCloseParticles(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inGRIntegrateCloseParticles *in = vIn;
	struct outGRIntegrateCloseParticles *out = vOut;
	int nMerged, k;
	double dMergerMassLost, aSunCorrection[3];

	mdlassert(pst->mdl,nIn == sizeof(struct inGRIntegrateCloseParticles));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_GRINTEGRATECLOSEPARTICLES,vIn,nIn);
		pstGRIntegrateCloseParticles(pst->pstLower,vIn,nIn,vOut,NULL);
		nMerged = out->nMerged;
		dMergerMassLost = out->dMergerMassLost;
		for (k = 0 ; k < 3 ; ++k)
		  aSunCorrection[k] = out->aSunCorrection[k]; 
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		out->nMerged += nMerged;
		out->dMergerMassLost += dMergerMassLost;
		for (k = 0 ; k < 3 ; ++k)
		  out->aSunCorrection[k] += aSunCorrection[k]; 
	}
	else 
	  pkdGRIntegrateCloseParticles(pst->plcl->pkd,in->dSunMass,in->dDelta,in->dTime,&out->nMerged, &out->dMergerMassLost, out->aSunCorrection);

	if (pnOut != NULL)
		*pnOut = sizeof(struct outGRIntegrateCloseParticles);
	}

void pstGRCorrectaSun(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
  struct inGRCorrectaSun *in = vIn;
  
  mdlassert(pst->mdl, nIn == sizeof(struct inGRCorrectaSun));
  if (pst->nLeaves > 1) {
    mdlReqService(pst->mdl, pst->idUpper, PST_GRCORRECTASUN,vIn,nIn);
    pstGRCorrectaSun(pst->pstLower,vIn,nIn,NULL,NULL);
    mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
  }
  else
    pkdGRCorrectaSun(pst->plcl->pkd,in->aSunCorrection);
  if (pnOut)
    *pnOut = 0;
...
#ifdef COLLISIONS
		plcl->pkd->bRepel = in->bRepel; /* easiest way to pass stuff to pkdBucketInteract() */
		plcl->pkd->dRepelFac = in->dRepelFac;
#endif
#ifdef SLIDING_PATCH
...
#endif
#ifdef SLIDING_PATCH
		/* mdlassert(pst->mdl,in->PP != NULL); --RB Debugging*/
		if (in->PP.bPatch) {
		  /*
...
void pstGetMassChange(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	LCL *plcl = pst->plcl;
	struct outGetMassChange *out = vOut;
	double dMassChange;
	
	mdlassert(pst->mdl,nIn == 0);
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_GETMASSCHANGE,NULL,0);
		pstGetMassChange(pst->pstLower,NULL,0,vOut,pnOut);
		dMassChange = out->dMassChange;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,pnOut);
		out->dMassChange += dMassChange;
		}
	else {
		out->dMassChange = pkdGetMassChange(plcl->pkd);
		}
	if (pnOut) *pnOut = sizeof(struct outGetMassChange);
	}
...
void pstNumRejects(PST pst,void *vin,int nIn,void *vout,int *pnOut)
{
	LCL *plcl = pst->plcl;
...
void pstAddUnifGrav(PST pst,void *vin,int nIn,void *vout,int *pnOut)
{
	LCL *plcl = pst->plcl;
	struct inAddUnifGrav *in = vin;

	mdlassert(pst->mdl,nIn == sizeof(struct inAddUnifGrav));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_ADDUNIFGRAV,in,nIn);
		pstAddUnifGrav(pst->pstLower,in,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else {
		pkdAddUnifGrav(plcl->pkd,in->dgx,in->dgy,in->dgz);
		}
	if (pnOut) *pnOut = 0;
	}

void pstNextCollision(PST pst,void *vin,int nIn,void *vout,int *pnOut)
{
	LCL *plcl = pst->plcl;
...
void pstGetColliderInfo(PST pst,void *vin,int nIn,void *vout,int *pnOut)
{
	LCL *plcl = pst->plcl;
...
void pstDoCollision(PST pst,void *vin,int nIn,void *vout,int *pnOut)
{
	...
	mdlassert(pst->mdl,nIn == sizeof(*in));
	local.nOut = out->nOut = -1; /* initialize (zero is a valid return value) */
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DOCOLLISION,vin,nIn);
		pstDoCollision(pst->pstLower,vin,nIn,vout,NULL);
		if (out->nOut >= 0) local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vout,NULL);
		if (local.nOut >= 0) {
			mdlassert(pst->mdl,out->nOut == -1); /* only 1 processor stores output info */
			*out = local;
			}
		}
	else {
...
#else
			pkdDoCollision(
						   pkd,in->dt,&in->Collider1,&in->Collider2,
						   in->bPeriodic,in->iStartStep,in->dDelta,
						   in->dTime,&in->CP,&out->iOutcome,&out->dT,
						   out->Out,&out->nOut
#ifdef COLLMOD_ZML
						   ,&in->DB,&out->iDustBin,&out->DustBin
#endif
						   );
#endif /* !AGGS */
			}
		}
	if (pnOut != NULL) *pnOut = sizeof(*out);
	}

void pstResetColliders(PST pst,void *vin,int nIn,void *vout,int *pnOut)
{
	LCL *plcl = pst->plcl;
...
void pstFindEscapers(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	LCL *plcl = pst->plcl;
	struct inFindEscapers *in = vIn;
	struct outFindEscapers *out = vOut;
	int nEsc;
	
	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_FINDESCAPERS,vIn,nIn);
		pstFindEscapers(pst->pstLower,vIn,nIn,vOut,pnOut);
		nEsc = out->nEsc;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,pnOut);
		out->nEsc += nEsc;
		}
	else {
		out->nEsc = pkdFindEscapers(plcl->pkd,in->dCentMass,in->dStarMass);
		}
	if (pnOut) *pnOut = sizeof(struct outFindEscapers);
	}

void pstCheckForKepler(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	LCL *plcl = pst->plcl;
	struct inCheckForKepler *in = vIn;
	struct outCheckForKepler *out = vOut;
	int nKep;
	
	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_CHECKFORKEPLER,vIn,nIn);
		pstCheckForKepler(pst->pstLower,vIn,nIn,vOut,pnOut);
		nKep = out->nKep;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,pnOut);
		out->nKep += nKep;
		}
	else {
		out->nKep = pkdCheckForKepler(plcl->pkd,in->dCentMass,in->dDelta);
		}
	if (pnOut) *pnOut = sizeof(struct outCheckForKepler);
	}
...
void pstFindTightestBinary(PST pst,void *vin,int nIn,void *vout,int *pnOut) 
{
  LCL *plcl = pst->plcl;
...
void pstMergeBinary(PST pst,void *vin,int nIn,void *vout,int *pnOut)
{
  LCL *plcl = pst->plcl;
  ...
  if (pst->nLeaves > 1) {
    ...
    if (in->c1.id.iPid == pkd->idSelf || in->c2.id.iPid == pkd->idSelf) {
      ...
      pkd->dTime = in->dTime;
#endif
      pkdMergeBinary(pkd,(const COLLIDER *) &in->c1,(const COLLIDER *) &in->c2,&out->cOut,in->bPeriodic,in->dDelta,in->dTime,in->iStartStep,in->dDensity,&out->n);
    }
    if (pnOut) *pnOut = sizeof(*out);
  }
}
...
void pstAggsFind(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	...
	if (pst->nLeaves > 1) {
		...
		iMaxIdx = out->iMaxIdx;
		iMaxOrg = out->iMaxOrg;		//For aggsReorder. JVD
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (iMaxIdx > out->iMaxIdx)
			out->iMaxIdx = iMaxIdx;
		if (iMaxOrg > out->iMaxOrg)
			out->iMaxOrg = iMaxOrg;
		}
	else
		pkdAggsFind(pst->plcl->pkd,&out->iMaxIdx,&out->iMaxOrg);
	if (pnOut) *pnOut = sizeof(*out);
	}

void pstAggsCountPart(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inAggsCountPart *in = vIn;
	struct outAggsCountPart *out = vOut;
	int nPart;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSCOUNTPART,vIn,nIn);
		pstAggsCountPart(pst->pstLower,vIn,nIn,vOut,NULL);
		nPart = out->nPart;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		out->nPart += nPart;
		}
	else
		pkdAggsCountPart(pst->plcl->pkd,in->iAggIdx,&out->nPart);
	if (pnOut) *pnOut = sizeof(*out);
	}
...
void pstAggsDelete(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	...
	struct outAggsDelete *out = vOut;
	int bFound;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSDELETE,vIn,nIn);
		pstAggsDelete(pst->pstLower,vIn,nIn,vOut,NULL);
		bFound = out->bFound;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (bFound) {
			mdlassert(pst->mdl,out->bFound == 0); /* only 1 particle to be found */
			out->bFound = 1;
			}
		}
	else {
		...
		*/
		pkd->PP = &in->PP;
		pkdAggsDelete(pkd,in->iAggIdx,in->dStepTime,in->dEventTime/*,in->dOmega*/,&out->bFound);
#else
		pkdAggsDelete(pkd,in->iAggIdx,&out->bFound);
#endif
		}
	if (pnOut) *pnOut = sizeof(*out);
	}
...
#ifdef FAST_AGGS
void pstAggsGetRef(PST pst,void *vIn,int nIn,void* vOut,int* pnOut)
{
	struct inAggsGetRef *in = vIn;
	struct outAggsGetRef local, *out = vOut;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSGETREF,vIn,nIn);
		pstAggsGetRef(pst->pstLower,vIn,nIn,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (out->r_ref[0] == 0 && out->r_ref[1] == 0 && out->r_ref[2] == 0)
			vectorCopy(local.r_ref,out->r_ref);
		}
	else {
		pkdAggsGetRef(pst->plcl->pkd,in->iAggIdx,out->r_ref);
		}
	if (pnOut) *pnOut = sizeof(*out);
	}

void pstAggsGetPeriodicCOM(PST pst,void *vIn,int nIn,void* vOut,int* pnOut)
{
	struct inAggsGetPeriodicCOM *in = vIn;
	struct outAggsGetPeriodicCOM local,*out = vOut;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSGETPERIODICCOM,vIn,nIn);
		pstAggsGetPeriodicCOM(pst->pstLower,vIn,nIn,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		out->m += local.m;
		out->mr[0] += local.mr[0];
		...
		pkdAggsGetPeriodicCOM(pst->plcl->pkd,in->iAggIdx,in->r_ref,&out->m,
							out->mr,out->mv);
		}
	if (pnOut) *pnOut = sizeof(*out);
	}
...
void pstAggsSetUnwrapped(PST pst,void *vIn,int nIn,void* vOut,int* pnOut)
{
	struct inAggsSetUnwrapped *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSSETUNWRAPPED,vIn,nIn);
		pstAggsSetUnwrapped(pst->pstLower,vIn,nIn,vOut,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		}
	else {
		pkdAggsSetUnwrapped(pst->plcl->pkd,in->iAggIdx,in->r_com);
		}
	if (pnOut) *pnOut = 0;
	}
#endif /*FAST_AGGS*/
...
#ifdef AGGS_IN_PATCH
	        pkdAggsGetCOM(pst->plcl->pkd,in->iAggIdx,&in->PP,&out->m,out->mr,out->mv);
#else
...
void pstAggsGetAxesAndSpin(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	...
	if (pst->nLeaves > 1) {
		...
		out->L[1] += local.L[1];
		out->L[2] += local.L[2];
		if (local.rad_max_sq > out->rad_max_sq)
			out->rad_max_sq = local.rad_max_sq;
		out->volume += local.volume;
		}
	else {
		PKD pkd = pst->plcl->pkd;
#ifdef AGGS_IN_PATCH
		pkd->PP = &in->PP;
#endif
		pkdAggsGetAxesAndSpin(pkd,in->iAggIdx,in->r_com,in->v_com,
							  out->I,out->L,&out->rad_max_sq,&out->volume);
		}
	if (pnOut) *pnOut = sizeof(*out);
	}
...
#ifdef AGGS_IN_PATCH
		pkdAggsSetSpacePos(pst->plcl->pkd,in->iAggIdx,in->r_com,in->lambda,in->dTime,&in->PP);
#else
...
void pstAggsSetSpaceVel(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	...
	if (pst->nLeaves > 1) {
		...
		pkd->PP = &in->PP;
#endif
		pkdAggsSetSpaceVel(pkd,in->iAggIdx,in->v_com,in->a_com,in->omega,in->omegadot,in->lambda,in->dDelta);
		}
	if (pnOut) *pnOut = 0;
	}
...
void pstAggsCheckStress(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	...
	struct outAggsCheckStress *out = vOut;
	int nLost,nLeft;
	...
	if (pst->nLeaves > 1) {
		...
		pkd->PP = &in->PP;
#endif
		pkdAggsCheckStress(pkd,in->iAggIdx,in->mass,in->rad_max,in->rad_eff,
						   in->r_com,in->a_com,in->omega,&in->SP,
						   &out->nLost,&out->nLeft);
		}
	if (pnOut) *pnOut = sizeof(*out);
	}
...
void pstAggsGetTorque(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	...
	if (pst->nLeaves > 1) {
		...
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		out->torque[0] += local.torque[0];
		out->torque[1] += local.torque[1];
		out->torque[2] += local.torque[2];
		}
	else
...
#else /* DEM */
void pstAggsGetAccelAndTorqueDEM(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	struct inAggsGetAccelAndTorqueDEM *in = vIn;
	struct outAggsGetAccelAndTorqueDEM local,*out = vOut;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSGETACCELANDTORQUEDEM,vIn,nIn);
		pstAggsGetAccelAndTorqueDEM(pst->pstLower,vIn,nIn,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		out->m += local.m;
		out->ma[0] += local.ma[0];
		...
		pkdAggsGetAccelAndTorqueDEM(pst->plcl->pkd,in->iAggIdx,in->r_com,&out->m,
						 out->ma,out->torque);

	if (pnOut) *pnOut = sizeof(*out);
	}

void pstAggsSetMassDEM(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inAggsSetMassDEM *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSSETMASSDEM,vIn,nIn);
		pstAggsSetMassDEM(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdAggsSetMassDEM(pst->plcl->pkd,in->iAggIdx,in->fMass);
	if (pnOut) *pnOut = 0;
	}
...
{
	struct inWallsUpdateStuckParticles *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_WALLSUPDATESTUCKPARTICLES,vIn,nIn);
		pstWallsUpdateStuckParticles(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdWallsUpdateStuckParticles(pst->plcl->pkd,&in->WP,in->bUpdatePos,in->dDelta);
	if (pnOut) *pnOut = 0;
	}
...
{
	struct inBreakSprings *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_BREAKSPRINGS,vIn,nIn);
		pstBreakSprings(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		in->bSpringsChanged = (int)pkdBreakSprings(pst->plcl->pkd,in->iOrder1,in->iOrder2);
	if (pnOut) *pnOut = 0;
	}
...
{
	struct outDEMWallsReact local,*out = vOut;
  int i;
	mdlassert(pst->mdl,nIn == 0);
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DEMWALLSREACT,NULL,0);
		pstDEMWallsReact(pst->pstLower,NULL,0,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
    for (i=0;i<MAX_NUM_WALL_ASSEMBLIES;i++) {
      out->dTotalXForceFromParticles[i] += local.dTotalXForceFromParticles[i];
      out->dTotalYForceFromParticles[i] += local.dTotalYForceFromParticles[i];
      out->dTotalZForceFromParticles[i] += local.dTotalZForceFromParticles[i];
      out->dTotalXTorqueFromParticles[i] += local.dTotalXTorqueFromParticles[i];
      out->dTotalYTorqueFromParticles[i] += local.dTotalYTorqueFromParticles[i];
      out->dTotalZTorqueFromParticles[i] += local.dTotalZTorqueFromParticles[i];
      }
		}
	else
    pkdDEMWallsReact(pst->plcl->pkd,out->dTotalXForceFromParticles,out->dTotalYForceFromParticles,out->dTotalZForceFromParticles,out->dTotalXTorqueFromParticles,out->dTotalYTorqueFromParticles,out->dTotalZTorqueFromParticles);
...
{
	struct inDEMZeroSmallMotions *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(struct inDEMZeroSmallMotions));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DEMZEROSMALLMOTIONS,vIn,nIn);
		pstDEMZeroSmallMotions(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdDEMZeroSmallMotions(pst->plcl->pkd,in->dAccCritSq,in->dDeltaSq);
	if (pnOut) *pnOut = 0;
	}

void pstDEMStats(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct outDEMStats local,*out = vOut;
	int i;

	mdlassert(pst->mdl,nIn == 0);
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DEMSTATS,NULL,0);
		pstDEMStats(pst->pstLower,NULL,0,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (local.DEMStats.fDistMin < out->DEMStats.fDistMin)
			out->DEMStats.fDistMin = local.DEMStats.fDistMin;
		if (local.DEMStats.fSpeedMax > out->DEMStats.fSpeedMax)
			out->DEMStats.fSpeedMax = local.DEMStats.fSpeedMax;
		for (i=0;i<DEM_NUM_OVERLAP_BINS;i++)
			out->DEMStats.pOverlapHist[i] += local.DEMStats.pOverlapHist[i];
		for (i=0;i<DEM_NUM_COS_A_BINS;i++)
			out->DEMStats.pCosAHist[i] += local.DEMStats.pCosAHist[i];
		for (i=0;i<DEM_NUM_S_BINS;i++)
			out->DEMStats.pSHist[i] += local.DEMStats.pSHist[i];
		}
	else
		pkdDEMStats(pst->plcl->pkd,&out->DEMStats);
	if (pnOut) *pnOut = sizeof(*out);
	}
  
#ifdef DEM_FIXED_BALL

void pstDEMSetBall(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inDEMSetBall *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DEMSETBALL,vIn,nIn);
		pstDEMSetBall(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdDEMSetBall(pst->plcl->pkd,in->dFixedRadius, in->iFixedBallOption);
	if (pnOut) *pnOut = 0;
	}

void pstDEMGetBallRadius(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inDEMGetBallRadius *in = vIn;
	struct outDEMGetBallRadius local,*out = vOut;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DEMGETBALLRADIUS,vIn,nIn);
		pstDEMGetBallRadius(pst->pstLower,vIn,nIn,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (in->iFixedBallOption==0) {
      if (local.dFixedRadius > out->dFixedRadius)
        out->dFixedRadius=local.dFixedRadius;
      }
		else if (in->iFixedBallOption==1)
			out->dFixedRadius+=local.dFixedRadius;
		else
			assert(0);
		}
	else
		pkdDEMGetBallRadius(pst->plcl->pkd, in->iFixedBallOption, &out->dFixedRadius);
	if (pnOut) *pnOut = sizeof(*out);
	}

void pstDEMFixedBallNextLargest(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
  mdlassert(pst->mdl,nIn == 0);
  if (pst->nLeaves > 1) {
    mdlReqService(pst->mdl,pst->idUpper,PST_DEMFIXEDBALLNEXTLARGEST,NULL,0);
    pstDEMFixedBallNextLargest(pst->pstLower,NULL,0,NULL,NULL);
    mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
  else
    pkdDEMFixedBallNextLargest(pst->plcl->pkd);
}
...
{
  struct ioChargeZMoments local,*out = vOut;

  mdlassert(pst->mdl,nIn == 0);
  if (pst->nLeaves > 1) {
    mdlReqService(pst->mdl,pst->idUpper,PST_CHARGEZGETMOMENTS,NULL,0);
    pstChargeZGetMoments(pst->pstLower,NULL,0,vOut,NULL);
    local = *out;
    mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
	out->CP.dQ += local.CP.dQ;
	out->CP.dZ += local.CP.dZ; /* this is actually q x z at the moment */
	out->CP.dSigZ += local.CP.dSigZ; /* this is actually q x z^2 at the moment */
 }
  else
	  pkdChargeZGetMoments(pst->plcl->pkd,&out->CP);
  if (pnOut) *pnOut = sizeof(*out);
}

void pstChargeZApplyMoments(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct ioChargeZMoments *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(struct ioChargeZMoments));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_CHARGEZAPPLYMOMENTS,vIn,nIn);
		pstChargeZApplyMoments(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdChargeZApplyMoments(pst->plcl->pkd,&in->CP);
	if (pnOut) *pnOut = 0;
}
...
{
	struct inDEMTidalFindPlanet *in = vIn;
	struct outDEMTidalFindPlanet local,*out = vOut;

	mdlassert(pst->mdl,nIn == sizeof(struct inDEMTidalFindPlanet));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DEMTIDALFINDPLANET,vIn,nIn);
		pstDEMTidalFindPlanet(pst->pstLower,vIn,nIn,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (local.bFound) *out = local; /* struct copy */
		}
	else
		pkdDEMTidalFindPlanet(pst->plcl->pkd,in->iColor,&out->bFound,out->dPos,out->dVel);
	if (pnOut) *pnOut = sizeof(*out);
	}

void pstDEMTidalFindMarker(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inDEMTidalFindMarker *in = vIn;
	struct outDEMTidalFindMarker local,*out = vOut;

	mdlassert(pst->mdl,nIn == sizeof(struct inDEMTidalFindMarker));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DEMTIDALFINDMARKER,vIn,nIn);
		pstDEMTidalFindMarker(pst->pstLower,vIn,nIn,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (local.bFound) *out = local; /* struct copy */
		}
	else
		pkdDEMTidalFindMarker(pst->plcl->pkd,in->iOrder,&out->bFound,out->dPos,out->dVel);
	if (pnOut) *pnOut = sizeof(*out);
	}
...
{
	struct inDEMTidal *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(struct inDEMTidal));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DEMTIDAL,vIn,nIn);
		pstDEMTidal(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdDEMTidal(pst->plcl->pkd,&in->d0,&in->d);
	if (pnOut) *pnOut = 0;
	}
...
{
	struct inAggsInPatchGetRef *in = vIn;
	struct outAggsInPatchGetRef local,*out = vOut;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSINPATCHGETREF,vIn,nIn);
		pstAggsInPatchGetRef(pst->pstLower,vIn,nIn,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (local.m_max > out->m_max) {
			out->m_max = local.m_max;
			vectorCopy(local.r_max,out->r_max);
			}
		}
	else
		pkdAggsInPatchGetRef(pst->plcl->pkd,in->iAggIdx,&out->m_max,out->r_max);
	if (pnOut) *pnOut = sizeof(*out);
	}

void pstAggsInPatchGetUnwrapped(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	struct inAggsInPatchGetUnwrapped *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSINPATCHGETUNWRAPPED,vIn,nIn);
		pstAggsInPatchGetUnwrapped(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdAggsInPatchGetUnwrapped(pst->plcl->pkd,in->iAggIdx,in->r_ref,in->dTime,&in->PP);
	if (pnOut) *pnOut = 0;
	}

void pstAggsInPatchOffset(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	struct inAggsInPatchOffset *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_AGGSINPATCHOFFSET,vIn,nIn);
		pstAggsInPatchOffset(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdAggsInPatchOffset(pst->plcl->pkd,in->iAggIdx,in->dx,in->dy,in->dvy,in->bDoUnwrapped);
	if (pnOut) *pnOut = 0;
	}
...
void pstSpinupGetAgg(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inSpinupGetAgg *in = vIn;
	struct outSpinupGetAgg local,*out = vOut;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_SPINUPGETAGG,vIn,nIn);
		pstSpinupGetAgg(pst->pstLower,vIn,nIn,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (local.bSuspend == 1)
			out->bSuspend = 1;
		...
		pkdSpinupGetAgg(pst->plcl->pkd,in->dRInner,in->dROuter,&out->bSuspend);
	if (pnOut) *pnOut = 0;
	}

void pstSpinupAlign(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inSpinupAlign *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_SPINUPALIGN,vIn,nIn);
		pstSpinupAlign(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdSpinupAlign(pst->plcl->pkd,in->r_com,in->vAxis,in->dAngle);
	if (pnOut) *pnOut = 0;
	}

void pstSpinup(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inSpinup *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_SPINUP,vIn,nIn);
		pstSpinup(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdSpinup(pst->plcl->pkd,in->r_com,in->spin);
	if (pnOut) *pnOut = 0;
	}
...
void pstSpinupAccel(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
	struct inSpinupAccel *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_SPINUPACCEL,vIn,nIn);
		pstSpinupAccel(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdSpinupAccel(pst->plcl->pkd,in->r_com,in->omegadot,in->bSpinupAlignAxes);
	if (pnOut) *pnOut = 0;
    }

void pstSpinupResetAggs(PST pst,void *vIn,int nIn,void *vOut,int *pnOut)
{
    if (pst->nLeaves > 1) {
        mdlReqService(pst->mdl,pst->idUpper,PST_SPINUPRESETAGGS,vIn,nIn);
        pstSpinupResetAggs(pst->pstLower,NULL,0,NULL,NULL);
        mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
        }
    else
        pkdSpinupResetAggs(pst->plcl->pkd);
    if (pnOut) *pnOut = 0; // NEEDED??
    }
...
{
	struct outDustBinsInclMax local,*out = vOut;

	/*	mdlassert(pst->mdl,nIn == sizeof(*in));*/
	out->dDustBinsInclMax = 0.0;
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DUSTBINSINCLMAX,vIn,nIn);
		pstDustBinsInclAvg(pst->pstLower,NULL,0,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (out->dDustBinsInclMax < local.dDustBinsInclMax)
		  out->dDustBinsInclMax = local.dDustBinsInclMax;
		}
	else
		out->dDustBinsInclMax = pkdDustBinsInclMax(pst->plcl->pkd);
	if (pnOut) *pnOut = sizeof(*out);
}

void pstDustBinsInclAvg(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	struct outDustBinsInclAvg local,*out = vOut;

	/*	mdlassert(pst->mdl,nIn == sizeof(*in));*/
	out->dDustBinsInclTot = 0.0;
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_DUSTBINSINCLAVG,vIn,nIn);
		pstDustBinsInclAvg(pst->pstLower,NULL,0,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		out->dDustBinsInclTot += local.dDustBinsInclTot;
		}
	else 
		out->dDustBinsInclTot = pkdDustBinsInclAvg(pst->plcl->pkd);
...
void pstDustBinsApply(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	...
	if (pst->nLeaves > 1) {
		...
		pkdDustBinsApply(pst->plcl->pkd,in->dCentMass,in->aMassIncrFrac,in->nBins,
				 in->dTimeInt,in->aDustBins,in->dVdisp
#ifdef ORIGIN_HISTOGRAM
						 ,in->aOriginBins
#endif /* ORIGIN_HISTOGRAM */
						 );
...
void pstRubCleanup(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	...
	for (i=0;i<in->DB.nDustBins;i++) {
		out->aDustBins[i].dMass = 0.0;
#ifdef ORIGIN_HISTOGRAM
		for (j=0;j<NUM_ORIGIN_BINS;j++)
			out->aDustBins[i].origin_bins[j] = 0.0;
#endif /* ORIGIN_HISTOGRAM */
		}
	out->DustBinsTrash.dMass = 0.0;
#ifdef ORIGIN_HISTOGRAM
	for (j=0;j<NUM_ORIGIN_BINS;j++)
		out->DustBinsTrash.origin_bins[j] = 0.0;
#endif /* ORIGIN_HISTOGRAM */
	if (pst->nLeaves > 1) {
		...
		for (i=0;i<in->DB.nDustBins;i++) {
#ifdef ORIGIN_HISTOGRAM
			if (local.aDustBins[i].dMass > 0.0)
				MergeHistograms(out->aDustBins[i].dMass, out->aDustBins[i].origin_bins, local.aDustBins[i].dMass, local.aDustBins[i].origin_bins);
#endif /* ORIGIN_HISTOGRAM */
			out->aDustBins[i].dMass += local.aDustBins[i].dMass;
			}
#ifdef ORIGIN_HISTOGRAM
		if (local.DustBinsTrash.dMass > 0.0)
			MergeHistograms(out->DustBinsTrash.dMass, out->DustBinsTrash.origin_bins, local.DustBinsTrash.dMass, local.DustBinsTrash.origin_bins);
#endif /* ORIGIN_HISTOGRAM */
		out->DustBinsTrash.dMass += local.DustBinsTrash.dMass;
		}
	else
		pkdRubCleanup(pst->plcl->pkd,in->iColor,&in->DB,in->dCentMass,
					  out->aDustBins,&out->DustBinsTrash);
	if (pnOut) *pnOut = sizeof(*out);
}
...
void pstRubInterpCleanup(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	...
	if (pst->nLeaves > 1) {
		...
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (local.DustBinsInterp.dMass > 0.0) {
			assert(out->DustBinsInterp.dMass == 0.0); /* sanity check: only one processor can report dust mass */
			*out = local;
			}
		}
	else
		pkdRubInterpCleanup(pst->plcl->pkd,&in->DB,in->dCentMass,in->iOrder,
							&out->iBin,&out->DustBinsInterp);
	if (pnOut) *pnOut = sizeof(*out);
}
...
void 
pstCollModResetColFlag(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	mdlassert(pst->mdl,nIn == 0);
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_COLLMODRESETCOLFLAG,NULL,0);
		pstCollModResetColFlag(pst->pstLower,NULL,0,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdCollModResetColFlag(pst->plcl->pkd);
}

void 
pstCollModCheckForKDKRestart(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	struct outCollModCheckForKDKRestart local,*out = vOut;

	mdlassert(pst->mdl,nIn == 0);
	out->bRestart = 0;
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_COLLMODCHECKFORKDKRESTART,NULL,0);
		pstCollModCheckForKDKRestart(pst->pstLower,NULL,0,vOut,NULL);
		local = *out;
		mdlGetReply(pst->mdl,pst->idUpper,vOut,NULL);
		if (local.bRestart) out->bRestart = 1;
		}
	else
		out->bRestart = pkdCollModCheckForKDKRestart(pst->plcl->pkd);
}

void 
pstCollModStep(PST pst,void* vIn,int nIn,void* vOut,int* pnOut)
{
	struct inCollModStep *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_COLLMODSTEP,vIn,nIn);
		pstCollModStep(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdCollModStep(pst->plcl->pkd,in->dMaxStep,in->dMinStep);
}
...
void pstInitializeOriginBins(PST pst,void* vIn,int nIn,void* vOut,int* pnOut) {
	struct inInitializeOriginBins *in = vIn;

	mdlassert(pst->mdl,nIn == sizeof(*in));
	if (pst->nLeaves > 1) {
		mdlReqService(pst->mdl,pst->idUpper,PST_INITIALIZEORIGINBINS,vIn,nIn);
		pstInitializeOriginBins(pst->pstLower,vIn,nIn,NULL,NULL);
		mdlGetReply(pst->mdl,pst->idUpper,NULL,NULL);
		}
	else
		pkdInitializeOriginBins(pst->plcl->pkd, &in->DB);
}
