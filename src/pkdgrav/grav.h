...
/* this version adds option of reverse gravity between particles */
...
{\
	...
	if ((r2) < (twoh)*(twoh)) {\
		...
		/*RP-DEBUG 6/22/09: Removing CONSTANT repel, to replace with linearly-scaling force    if (pkd->bRepel) b *= pkd->dRepelFac;*/ \
	}								\
	else {								\
	  a = SPLINE_dir;						\
	  b = a*a*a;							\
